...
@Component
public class TrackColumnListOutput extends DefaultOutput<List<TrackColumnBean>> {
	private Logger logger = LogManager.getLogger(this.getClass());

	@Override
	protected String transferSuccessData(List<TrackColumnBean> t, ClientInfo clientInfo)
			throws Exception {
		try {
