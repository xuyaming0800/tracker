...
import cn.com.leador.mapapi.tracker.track.input.TrackBatchAddInput;
import cn.com.leador.mapapi.tracker.track.output.TrackBatchAddOutput;
@WebController
public class TrackBatchAddController extends HttpServletProxy {
	...
	private void init(){
		...
		input=SpringContextHelper.getBeanByType(TrackBatchAddInput.class);
		trans=SpringContextHelper.getBeanByType(TrackBatchAddOutput.class);
	}

	@Override
	@UriMapping(value="/track/addpoints",sid="100009",name="track批量上传")
