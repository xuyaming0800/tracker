...
@Component
public class EntityColumnListOutput extends DefaultOutput<List<EntityColumnBean>> {
	private Logger logger = LogManager.getLogger(this.getClass());

	@Override
	protected String transferSuccessData(List<EntityColumnBean> t, ClientInfo clientInfo)
			throws Exception {
		try {
