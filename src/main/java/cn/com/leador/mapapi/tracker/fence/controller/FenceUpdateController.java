...
import cn.com.leador.mapapi.tracker.fence.input.FenceUpdateInput;
import cn.com.leador.mapapi.tracker.fence.output.FenceUpdateOutput;
@WebController
public class FenceUpdateController extends HttpServletProxy {
	...
	private void init(){
		...
		input=SpringContextHelper.getBeanByType(FenceUpdateInput.class);
		trans=SpringContextHelper.getBeanByType(FenceUpdateOutput.class);
	}

	@Override
	@UriMapping(value="/fence/update",sid="100020",name="更新围栏")
